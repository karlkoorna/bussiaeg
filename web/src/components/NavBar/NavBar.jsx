...
export default function NavBar() {
	return (
		<div id="navbar">
			...
			<NavBarItem to="/directions" colors={[ '#a284e0', '#c1adea' ]}>directions</NavBarItem>
...
class NavBarItem extends PureComponent {
	...
	render() {
		...
		let [ primaryColor, secondaryColor ] = window.location.pathname === to ? colors : [ '#b3b3b3', '#bfbfbf' ];
		
		return (
			<NavLink className="navbar-item" title={children.charAt(0).toUpperCase() + children.substr(1)} to={to} exact onClick={this.animate.bind(this)}>
				...
				{{
					search: (
						<g>
							...
							<circle cx="399.3" cy="399.3" r="347" fill="none" stroke={primaryColor} strokeWidth="100" />
						</g>
					),
					favorites: (
					...
					directions: (
						<g>
							<circle cx="513" cy="515" r="465" fill="none" stroke={primaryColor} strokeWidth="100" />
							<path fill={secondaryColor} d="M420.1 422.1l-165.2 351 351-165.2 165.2-351-351 165.2zM513 579c-35.3 0-64-28.7-64-64s28.7-64 64-64 64 28.7 64 64-28.7 64-64 64z" />
						</g>
					),
					settings: (
						<g>
							...
							<circle cx="512" cy="512" r="205.6" fill="none" stroke={primaryColor} strokeWidth="100" />
						</g>
					)
				}[children]}
				</svg>
